...
patch(
    ...
    '        #\n'
    '        # NACE VACÍA A PROPÓSITO. Con el valor de Sintergica aquí,\n'
    '        # configure_instance —que corre al arrancar el api— la creaba en\n'
    '        # instancias YA configuradas contra otro proveedor, y como esta clave\n'
    '        # manda sobre el mapa por nombre, sus modelos salían hacia un endpoint\n'
    '        # donde no existen. Pasó en tequio.sintergica.ai el 5 Sep 2026, que iba\n'
    '        # por OpenRouter. El formulario de /god-mode/ai/ ya propone la URL de\n'
    '        # Sintergica cuando está vacía, así que una instalación nueva la ve\n'
    '        # igual: la diferencia es que ahora la elige una persona.\n'
    '        "key": "LLM_BASE_URL",\n'
